...
import { getUsersController, getUserController, createUserController, updateUserController, deleteUserController, bulkUpdateUsersController, bulkDeleteUsersController, userStatsController, } from '../controllers/userController.js';
const router = Router();
