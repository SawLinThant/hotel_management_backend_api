...
export async function registerGuestController(req: Request, res: Response) {
...
export async function registerStaffController(req: Request, res: Response) {
...
export async function loginGuestController(req: Request, res: Response) {
...
export async function loginStaffController(req: Request, res: Response) {
	const payload = loginSchema.parse(req.body);
	try {
...
export async function logoutAllSessionsController(req: Request, res: Response) {
    try {
