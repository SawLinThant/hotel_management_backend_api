...
export async function changePasswordController(_req: Request, res: Response) {
...
export async function requestPasswordResetController(_req: Request, res: Response) {
  return res.status(202).json({ queued: false });
}

export async function confirmPasswordResetController(_req: Request, res: Response) {
  return res.status(501).json({ message: 'Password reset confirmation not implemented' });
}

export async function sendVerificationController(_req: Request, res: Response) {
  return res.status(202).json({ queued: false });
}

export async function verifyEmailController(_req: Request, res: Response) {
