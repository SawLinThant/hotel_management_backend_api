...
export async function createBooking(data: CreateBookingData, userRole: Role, userId: string): Promise<any> {
	// Validate dates
...
// Cancel booking
export async function cancelBooking(id: string, userRole: Role, userId: string): Promise<{ message: string }> {
