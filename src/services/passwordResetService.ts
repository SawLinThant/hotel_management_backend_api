...
async function sendPasswordResetEmail(email: string, resetToken: string, userName: string): Promise<void> {
...
export async function validateResetToken(token: string): Promise<{ valid: boolean; user?: any }> {
